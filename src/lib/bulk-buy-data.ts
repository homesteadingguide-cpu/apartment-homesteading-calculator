...
export const PROCESSING_METHODS: ProcessingMethod[] = [
  ...
  },
  {
    id: 'make-jam',
    name: 'Make Jam',
    description: 'Cook fruit and sugar into a small-batch jam for the fridge and freezer',
    storageLocation: 'fridge',
...
export const BULK_ITEMS: BulkItem[] = [
    ...
    diversions: {
      methods: [
        ...
        },
        {
          ...
          spacePerLb: '½ cup chips',
          cubicFtPerLb: 0.01,
          processingTimePerLb: '~15 min prep + 6-24 hrs drying',
          passiveTimePerLb: '',
          instructions: 'Wash and core (peeling is optional). Slice into 1/8 to 1/4 inch rings. Soak 10 minutes in equal parts lemon juice and water, then drain well. Lay in a single layer and dry at 140°F until pliable and leathery with no moist spot in the middle (6 to 24 hrs; a dehydrator is quicker than an oven). Cool, then keep in a loosely packed jar for about a week (shaking daily) before storing airtight in a cool, dark, dry place.',
          shelfLife: '6-12 months in pantry',
        },
        {
          methodId: 'make-sauce',
    ...
    diversions: {
      methods: [
        ...
        },
        {
          ...
          cubicFtPerLb: 0.012,
          processingTimePerLb: '~15 min prep + 20-40 min cook',
          passiveTimePerLb: '',
          instructions: 'Hull and crush the berries, then measure them in cups. Stir in the same number of cups of sugar (no lemon needed). Bring slowly to a boil, stirring until the sugar dissolves, then boil hard, stirring constantly, until a spoonful wrinkles on a cold plate or the jam reaches 220°F. Skim off the foam and ladle into clean jars. Cool, lid, and keep in the fridge or freezer. Make it in batches of about 4 cups of crushed fruit at a time.',
          shelfLife: '3 weeks in fridge, up to 1 year in freezer',
        },
        {
          methodId: 'dehydrate',
          minWeightLbs: 1,
          ...
          cubicFtPerLb: 0.006,
          processingTimePerLb: '~10 min prep + 24-36 hrs drying',
          passiveTimePerLb: '',
          instructions: 'Hull and halve (or leave small berries whole). Soak 10 minutes in equal parts lemon juice and water, then drain. Lay in a single layer, no more than 2 berries deep, and dry at 140°F until hard and the berries rattle when shaken (24 to 36 hrs). Cool, then keep in a loosely packed jar for about a week (shaking daily) before storing airtight in a cool, dark, dry place.',
          shelfLife: '6-12 months in pantry',
        },
        {
          methodId: 'make-sauce',
  ...
  },
  {
    ...
    category: 'fruit',
    tips: [
      'U-pick farms in season are the cheapest way to buy a flat of berries.',
      'Process within 24 hours; they mold fast at room temperature.',
      'Don\'t wash until you\'re ready to process: moisture speeds spoilage.',
      'Firm berries, with a few slightly under-ripe ones mixed in, set best in jam.',
    ],
    diversions: {
      methods: [
        {
          ...
          processingTimePerLb: '~10 min active',
          passiveTimePerLb: '+ 2 hrs freezing',
          instructions: 'Rinse gently and pat dry. Spread whole berries in a single layer on a parchment-lined sheet pan. Freeze until solid (2+ hrs), then transfer to freezer bags, press flat, and store. Use straight from frozen for smoothies, baking, or jam.',
          shelfLife: '8-12 months in freezer',
        },
        {
          methodId: 'make-jam',
          ...
          processingTimePerLb: '~15 min prep + 20-40 min cook',
          passiveTimePerLb: '',
          instructions: 'Crush the berries, then measure them in cups. Stir in the same number of cups of sugar (no lemon needed). Bring slowly to a boil, stirring until the sugar dissolves, then boil hard, stirring constantly, until a spoonful wrinkles on a cold plate or the jam reaches 220°F. For seedless jam, heat the crushed berries until soft and press through a sieve before adding the sugar. Skim, ladle into clean jars, cool, lid, and keep in the fridge or freezer. Make it in batches of about 4 cups of crushed fruit at a time.',
          shelfLife: '3 weeks in fridge, up to 1 year in freezer',
        },
        {
          methodId: 'make-sauce',
          ...
          processingTimePerLb: '~10 min prep + 15 min cook',
          passiveTimePerLb: '',
          instructions: 'Cook down with a little sugar until thick and jammy (15 min). Press through a sieve if you want it seedless. Portion into freezer bags, press flat, and freeze. Great on pancakes, yogurt, or ice cream.',
          shelfLife: '6 months in freezer',
        },
      ],
    },
    ...
    diversions: {
      methods: [
        ...
        },
        {
          ...
          passiveTimePerLb: '',
          instructions: 'Peel, pit and crush the peaches, then measure them in cups. For every 5½ to 6 cups of crushed peaches stir in 4 to 5 cups of sugar and 2 tablespoons of lemon juice. Bring slowly to a boil, stirring until the sugar dissolves, then boil hard, stirring constantly, until a spoonful wrinkles on a cold plate or the jam reaches 220°F. Skim, ladle into clean jars, cool, lid, and keep in the fridge or freezer.',
          shelfLife: '3 weeks in fridge, up to 1 year in freezer',
        },
        {
          methodId: 'dehydrate',
          ...
          spacePerLb: '⅓ cup dried',
          cubicFtPerLb: 0.008,
          processingTimePerLb: '~10 min prep + 6-36 hrs drying',
          passiveTimePerLb: '',
          instructions: 'Peel, halve, pit and slice if you like. Soak 10 minutes in equal parts lemon juice and water, then drain well. Lay in a single layer and dry at 140°F until leathery and somewhat pliable (6 to 36 hrs; turn halves over when the juice disappears). Cool, then keep in a loosely packed jar for about a week (shaking daily) before storing airtight in a cool, dark, dry place.',
          shelfLife: '6-12 months in pantry',
        },
      ],
    },
    ...
    diversions: {
      methods: [
        ...
        },
        {
          ...
          spacePerLb: '⅓ cup chips',
          cubicFtPerLb: 0.008,
          processingTimePerLb: '~10 min prep + 6-10 hrs drying',
          passiveTimePerLb: '',
          instructions: 'Peel firm, ripe bananas and slice into 1/8 inch rounds. Soak 10 minutes in equal parts lemon juice and water, then drain gently. Lay in a single layer and dry at 140°F until tough and leathery (6 to 10 hrs). Cool, then keep in a loosely packed jar for about a week (shaking daily) before storing airtight in a cool, dark, dry place.',
          shelfLife: '6-12 months in pantry',
        },
        {
          methodId: 'make-butter',

...
export const metadata: Metadata = {
  title: 'Balcony-to-Pantry | Apartment Homesteading Tools',
  description:
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <SiteHeader />
        {children}
        <footer className="mt-auto border-t border-stone-200/60 bg-white/60 backdrop-blur-sm">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 text-center text-xs text-stone-400">
            <p>
